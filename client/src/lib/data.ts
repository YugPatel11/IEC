...
export const impactNumbers = [
  { value: 120, suffix: '+', label: 'Startups Supported', prefix: '' },
  { value: 75, suffix: '+', label: 'IPR Filed', prefix: '' },
  { value: 15000, suffix: '+', label: 'Students Reached', prefix: '' },
  { value: 8, suffix: 'Cr+', label: 'Funding Facilitated', prefix: '₹' },
  { value: 200, suffix: '+', label: 'Mentoring Sessions', prefix: '' },
  { value: 50, suffix: '+', label: 'Events Conducted', prefix: '' },
];

export const announcements = [
  'Applications open for Pre-Incubation Cohort 2026',
  'SSIP Grant window closes Aug 30',
  'Demo Day — Sept 15 at PPSU Auditorium',
...
export const mentorCoordinators = [
  { name: 'Dr. Parag Sanghani', role: 'Provost', image: '/images/parag.jpg' },
  { name: 'Dr. Bindesh Patel', role: 'IEC Incharge', image: '/images/bindesh.jpg' },
  { name: 'Dr. Chirag Desai', role: 'Assistant Registrar', image: '/images/chirag.jpg' },
  { name: 'Mr. Sanjay Panjabi', role: 'Mentor', image: '/images/sanjay.jpg' },
];

export const mentorBoard = [
  { name: 'Dr. Balraj Tudu', role: 'School of Engineering' },
  { name: 'Dr. Amit Sharma', role: 'School of Engineering' },
  { name: 'Dr. Ashutosh Kumar', role: 'School of Science' },
  { name: 'Dr. Chirag V Khambhu', role: 'School of Agriculture' },
  { name: 'Dr. Anam Natalwala', role: 'School of Liberal Arts & Management' },
  { name: 'Dr. Matangee Pandya', role: 'School of Ayurveda' },
  { name: 'Ms. Riya S. Shukal', role: 'School of Nursing' },
  { name: 'Mr. Bhavin M. Patel', role: 'School of Design' },
  { name: 'Dr. Vidhi Bhanushali', role: 'School of Physiotherapy' },
  { name: 'Mr. Rishiraj Solanki', role: 'School of Homeopathy' },
  { name: 'Dr. Nevil Gandhi', role: 'School of Liberal Arts & Management' },
  { name: 'Mr. Kishan Madhavani', role: 'School of Pharmacy' },
];

export const ebcCoreMembers = [
  { name: 'Viraam Gohil', role: 'President', image: '/images/viraam.jpg' },
  { name: 'Yug Rojiwadiya', role: 'Incharge President', image: '/images/Yug.jpg' },
